      ...
      >
        <div className="flex items-center justify-between">
          ...
          <div className="md:hidden">
            <button
              type="button"
              className="w-8 h-8 flex justify-center items-center text-sm font-semibold rounded-full border border-gray-200 text-gray-800 hover:bg-gray-100"
              onClick={toggleMenu}
        ...
        <div
          className={twMerge(
            "overflow-hidden transition-all duration-300 basis-full grow md:block ml-1 my-2",
